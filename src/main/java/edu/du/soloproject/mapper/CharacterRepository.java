...
public interface CharacterRepository {
    @Select("SELECT id, name, role, difficulty, description, image_url as imageUrl FROM characters")
    List<Character> getAllCharacters();

    @Insert("INSERT INTO characters (name, role, difficulty, description, image_url) VALUES (#{name}, #{role}, #{difficulty}, #{description}, #{imageUrl})")
